                    ...
                    VStack(spacing: 16) {
                            ...
                            TextField("Enter your first name", text: $firstName)
                                ...
                                .overlay(
                                    RoundedRectangle(cornerRadius: 8)
                                        .stroke(firstNameError != nil ? Color.red : Color(AppColors.border), lineWidth: 1)
                                )
                        ...
                        VStack(alignment: .leading, spacing: 8) {
                            ...
                            TextField("Enter your last name", text: $lastName)
                                ...
                                .overlay(
                                    RoundedRectangle(cornerRadius: 8)
                                        .stroke(lastNameError != nil ? Color.red : Color(AppColors.border), lineWidth: 1)
                                )
                        ...
                        VStack(alignment: .leading, spacing: 8) {
                            ...
                            .overlay(
                                RoundedRectangle(cornerRadius: 8)
                                    .stroke(passwordError != nil ? Color.red : Color(AppColors.border), lineWidth: 1)
                            )
                        ...
                        VStack(alignment: .leading, spacing: 8) {
                            ...
                            TextField("Enter your phone number", text: $phoneNumber)
                                ...
                                .overlay(
                                    RoundedRectangle(cornerRadius: 8)
                                        .stroke(phoneNumberError != nil ? Color.red : Color(AppColors.border), lineWidth: 1)
                                )
